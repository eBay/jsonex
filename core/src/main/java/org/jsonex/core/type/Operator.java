...
public class Operator {
  ...
  public static<T, R1>  Function<T, R1> safeOf(Function<T, R1> f1) { return t -> LangUtil.safe(t, f1); }
  public static<T, R1, R2>  Function<T, R2> safeOf(Function<T, R1> f1, Function<R1, R2> f2) { return t -> LangUtil.safe(t, f1, f2); }
  public static <T, R1, R2, R3> Function<T, R3> safeOf(Function<T, R1> f1, Function<R1, R2> f2, Function<R2, R3> f3) { return t -> LangUtil.safe(t, f1, f2, f3); }
  public static <T, R1, R2, R3, R4> Function<T, R4> safeOf(Function<T, R1> f1, Function<R1, R2> f2, Function<R2, R3> f3, Function<R3, R4> f4) { return t -> LangUtil.safe(t, f1, f2, f3, f4); }
}
